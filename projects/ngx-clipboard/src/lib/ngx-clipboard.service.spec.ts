...
describe('Service: Clipboard', () => {
  ...
  describe('check if input is valid', () => {
    ...
    it(
      'input[disabled] is NOT a valid target',
      inject([ClipboardService], (service: ClipboardService) => {
        input.setAttribute('disabled', '');
        expect(() => service.isTargetValid(input)).toThrowError(
  ...
  describe('check if textarea is valid', () => {
    ...
    it(
      'ta[disabled] is NOT a valid target',
      inject([ClipboardService], (service: ClipboardService) => {
  ...
  describe('check if other html element is valid', () => {
    let div: any;
    it(
      'undefined is NOT a valid target',
      inject([ClipboardService], (service: ClipboardService) => {
        expect(() => service.isTargetValid(div)).toThrowError(
          'Target should be input or textarea'
        );
      })
    );
    it(
      'div is NOT a valid target',
      inject([ClipboardService], (service: ClipboardService) => {
